        ...
        <div id="team">
            <div className="team-out">
                <div className="member">
                    <h1 className="member-name">Anselmo Henrique</h1>
                ...
                <div className="member">
                    <h1 className="member-name">Gabriel Pelizzaro</h1>
                    <div className="line"></div>
                ...
                <div className="member">
                    <h1 className="member-name">Bruno Wotzke</h1>
                    <div className="line"></div>
                ...
                <div className="member">
                    <h1 className="member-name">Alexis Reales</h1>
                    <div className="line"></div>
                ...
                <div className="member">
                    <h1 className="member-name">Arthur Rocha</h1>
                    <div className="line"></div>
                ...
                <div className="member">
                    <h1 className="member-name">Igor Blaska</h1>
                    <div className="line"></div>
